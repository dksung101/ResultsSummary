...
const List = ({reaction, memory, verbal, visual}) => {
  return (
    <div className='list-container'>
      ...
      <ul>
        ...
        <div className='left'>Reaction</div></div><div className='right'>{reaction}/100</div></li>
       
        <li className='memory-list'>
        <div className='iconplus'>
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" 
        viewBox="0 0 20 20"><path stroke="#FFB21E" strokeLinecap="round" strokeLinejoin="round" 
        strokeWidth="1.25" d="M5.833 11.667a2.5 2.5 0 1 0 .834 4.858"/><path stroke="#FFB21E" 
        strokeLinecap="round" strokeLinejoin="round" 
        strokeWidth="1.25" d="M3.553 13.004a3.333 3.333 0 0 1-.728-5.53m.025-.067a2.083 2.083 0 0 1 2.983-2.824m.199.054A2.083 2.083 0 1 1 10 3.75v12.917a1.667 1.667 0 0 1-3.333 0M10 5.833a2.5 2.5 0 0 0 2.5 2.5m1.667 3.334a2.5 2.5 0 1 1-.834 4.858"/><path stroke="#FFB21E"
        strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" d="M16.447 13.004a3.334 3.334 0 0 0 .728-5.53m-.025-.067a2.083 2.083 0 0 0-2.983-2.824M10 3.75a2.085 2.085 0 0 1 2.538-2.033 2.084 2.084 0 0 1 1.43 2.92m-.635 12.03a1.667 1.667 0 0 1-3.333 0"/></svg> 
        <div className='left'>Memory</div></div> <div className='right'>{memory}/100</div></li>
        ...
        <div className='left'>Verbal</div></div> <div className='right'>{verbal}/100</div></li>
        ...
        <span className='left'>Visual</span></div> <span className='right'>{visual}/100</span></li>
